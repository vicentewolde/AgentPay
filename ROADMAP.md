...
Última revisión: 2026-09-02 · Fase actual: **Fase 2 en curso — T10 cerrado, T11 siguiente**
...
| 2 | **Agente mínimo de compra** | Un agente puede leer un catálogo real y producir una intención de compra firmada y trazable a su credencial, y ese poder se le puede quitar sin tocarlo | 🔄 En curso — T9, T10 cerrados | Respuestas del embajador, **solo para T15** (preguntas ya redactadas, ver Fase 2) |
